...
class AddDeviseToAdministrators < ActiveRecord::Migration[7.1]
  def self.up
    change_table :administrators do |t|
      ...
      # Remove the line below since the email column already exists
      ...
      ## Uncomment the lines below if you want to track sign-in and confirmable
    ...
    # Remove the line below since the email index already exists
